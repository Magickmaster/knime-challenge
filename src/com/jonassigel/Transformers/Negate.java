...
/**
 * Function to negate an input. Sadly, typing issues require a new
 * implementation for each Number type. This is to allow instatiated Number
 * types to remain purity and would require many waring flags.
 */
